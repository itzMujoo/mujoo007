#!/usr/bin/python2
#coding=utf-8
#DEVIL MUJOO THE OFFICAL ROGRAMMER 
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username  #DEV DEVIL MUJOO
            loop = 'false'
        else:
...
def login1():
	...
	try:
		...
		if 'checkpoint' in url:
			print("\n\x1b[1;97mDear Your Account is on Checkpoint")
			os.system('rm -rf login.txt')
			time.sleep(1)
			keluar()
		else:
...
def menu():
	...
	jalan( "\033[1;93m⊱⋕⊰═════════════════════════════════════════⊱⋕⊰") 
	print "\033[1;32;98m[1] \033[1;96m>> START CLONING WITH DEVIL 😈 "																														
...
def super():
	...
	print logo
	print "\033[1;96m⊱⋕⊰══════════════════════════════════════════⊱⋕⊰\n" 
	jalan( "\x1b[1;32;92m[1] \033[1;33;98m>> Clone From Public ID 😈") 
